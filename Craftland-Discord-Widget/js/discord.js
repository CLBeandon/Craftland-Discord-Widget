...
$.getJSON('https://discordapp.com/api/servers/' + serverID + '/widget.json', function(data) {
    ...
    var admins = ["247440554617602056", "168901714542460928", "176501341194158081", "257240600267456513", "160449870916747274", "339355329462796289"];
...
for (o = 0; o < 4; o++) {
	for (i = 0; i < data.members.length; i++) {
        ...
        // Hardset Admins
        if (userid == "247440554617602056" || userid == "168901714542460928" || userid == "176501341194158081" || userid == "257240600267456513" || userid == "160449870916747274" || userid == "339355329462796289") {
